...
const saveWishlistToStorage = (wishlistKey, wishlist) => {
    try {
        ...
        window.dispatchEvent(new StorageEvent('storage', { key: wishlistKey, newValue: JSON.stringify(wishlist) }));
    } catch (error) {
...
const ProductPage = () => {
    ...
    const userId = user?.userId || 'default-user'; // Add default-user fallback for consistency
                ...
                <div className="flex flex-row gap-6 w-full lg:w-1/2">
                    ...
                    <div className="relative flex-1 flex justify-center items-start">
                        <img
                            ...
                            style={{ maxHeight: 'calc(96*0.25rem)' }}
                        />
                    </div>
                </div>

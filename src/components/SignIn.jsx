    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-bold text-gray-800">{isLoggedIn ? 'USER' : 'SIGN IN'}</h3>
          <button
          ...
          <div className="flex border-b border-gray-200 mb-6">
            <button
              className={`flex-1 py-3 text-center font-medium text-sm uppercase tracking-wider ${
                activeTab === 'login' ? 'border-b-2 border-teal-600 text-teal-600' : 'text-gray-500'
              }`}
            ...
            <button
              className={`flex-1 py-3 text-center font-medium text-sm uppercase tracking-wider ${
                activeTab === 'register' ? 'border-b-2 border-teal-600 text-teal-600' : 'text-gray-500'
              }`}
